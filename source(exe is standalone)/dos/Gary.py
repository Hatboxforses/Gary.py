...
def scene_1():
    ...
    choice = raw_input("Do you want to check the scene or ignore it? ").lower()
...
def scene_2():
    ...
    direction = raw_input("Do you want to buy or pirate it? ").lower()
...
def scene_3():
    ...
    direction = raw_input("Do you want to a buy digital or physical copy? ").lower()
...
def scene_5():
    ...
    choice = raw_input("Should Gary cook Popeyes Spicy Chicken Sandwich Combo or Oreo Chocolate Sandwich Cookie? ").lower()
...
def scene_6():
    ...
    choice = raw_input("Which store does he go to walmart or target? ").lower()
...
def scene_7():
    ...
    choice = raw_input("Does he? ").lower()
...
def scene_9():
    ...
    choice = raw_input("What did Gary buy? ").lower()

    if choice == "coffee":
        print("Good job")
        scene_11()
    elif choice == "meth":
        print("The truth cane out")
        scene_10()
    else:
        print("Invalid choice. Try again.")
        scene_9()
...
def scene_10():
    ...
    choice = raw_input("What did the Devil give Adam? ").lower()
...
def scene_11():
    print("Good job or bad job depending on what you chose")
    choice = raw_input("restart?" ).lower()
